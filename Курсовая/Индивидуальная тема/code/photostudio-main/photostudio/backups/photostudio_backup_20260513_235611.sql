...
\restrict VLo1WXfn8BdC7TzdNUvUci7AFJmeZr9u0wHAe3vRqr0taRiih45srSFRDLP27hE
...
ALTER TABLE IF EXISTS ONLY public.tariffs DROP CONSTRAINT IF EXISTS tariffs_service_id_foreign;
ALTER TABLE IF EXISTS ONLY public.client_booking_statistics DROP CONSTRAINT IF EXISTS client_booking_statistics_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.bookings DROP CONSTRAINT IF EXISTS bookings_client_id_foreign;
ALTER TABLE IF EXISTS ONLY public.booking_items DROP CONSTRAINT IF EXISTS booking_items_tariff_id_foreign;
ALTER TABLE IF EXISTS ONLY public.booking_items DROP CONSTRAINT IF EXISTS booking_items_service_id_foreign;
ALTER TABLE IF EXISTS ONLY public.booking_items DROP CONSTRAINT IF EXISTS booking_items_booking_id_foreign;
...
ALTER TABLE IF EXISTS ONLY public.clients DROP CONSTRAINT IF EXISTS clients_phone_unique;
ALTER TABLE IF EXISTS ONLY public.client_booking_statistics DROP CONSTRAINT IF EXISTS client_booking_statistics_pkey;
ALTER TABLE IF EXISTS ONLY public.client_booking_statistics DROP CONSTRAINT IF EXISTS client_booking_statistics_client_id_key;
...
ALTER TABLE IF EXISTS public.tariffs ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.client_booking_statistics ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.bookings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.booking_items ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.client_booking_statistics_id_seq;
DROP TABLE IF EXISTS public.client_booking_statistics;
DROP TABLE IF EXISTS public.cache_locks;
DROP TABLE IF EXISTS public.cache;
DROP SEQUENCE IF EXISTS public.bookings_id_seq;
DROP TABLE IF EXISTS public.bookings;
DROP SEQUENCE IF EXISTS public.booking_items_id_seq;
DROP TABLE IF EXISTS public.booking_items;
DROP PROCEDURE IF EXISTS public.refresh_client_booking_statistics(IN result_cursor refcursor);
--
-- Name: refresh_client_booking_statistics(refcursor); Type: PROCEDURE; Schema: public; Owner: -
--
...
--
-- Name: client_booking_statistics; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: client_booking_statistics_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: client_booking_statistics_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: client_booking_statistics id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: client_booking_statistics; Type: TABLE DATA; Schema: public; Owner: -
--
...
1	Женская фотосъёмка	zhenskaya-fotosyomka	Портретная и имиджевая съёмка для девушек.	Индивидуальная фотосессия в студии с подбором образа, света и фона.	\N	t	10	2026-05-01 20:19:06	2026-05-01 20:19:06
...
JAl8mYgOzzWSgSwfAzDbTcDjPwNDrMxukSIBt0U5	1	127.0.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 YaBrowser/26.4.0.0 Safari/537.36		1778704699
\.
...
SELECT pg_catalog.setval('public.booking_items_id_seq', 36, true);
...
--
-- Name: client_booking_statistics_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: client_booking_statistics client_booking_statistics_client_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: client_booking_statistics client_booking_statistics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: booking_items booking_items_booking_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: booking_items booking_items_service_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: booking_items booking_items_tariff_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: client_booking_statistics client_booking_statistics_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tariffs tariffs_service_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict VLo1WXfn8BdC7TzdNUvUci7AFJmeZr9u0wHAe3vRqr0taRiih45srSFRDLP27hE
